...
- [x] S3 구현          — 2026-08-24 / CI gate PASS / web·worker 이미지 및 운영 배포 완료
...
- [x] `pnpm gate` 통과
- [x] 잔존 `NotImplementedError('T06:...')` = 0
- [x] `packages/media` 커버리지 ≥ 85%
- [x] 순수 함수 테스트 전부 통과 (특히 세로 영상 + 짝수 크기)
- [x] 실제 ffmpeg 통합 테스트 통과
- [x] 멱등성 테스트 통과 (잡 2회 → 렌디션 중복 없음)
